...
export default function Card({ src, secondSrc, text, rating, price, discount, newProduct }: Product) {
  ...
  return (
    <Link href="/">
      <div className="relative flex flex-col items-start text-[#23232c] group cursor-pointer mb-2 w-fit">
